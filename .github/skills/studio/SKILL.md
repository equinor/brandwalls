---
name: studio
description: Brandwalls Sanity Studio coding standards, content modeling patterns, and component guidelines. Use this when working on studio code
---

# Brandwalls Studio Instructions
