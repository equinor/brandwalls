...
export default {
  ...
  fields: [
    ...
    defineField({
      ...
      components: {
        input: (props) => (
          <RadioInput {...props} options={contentXAlignmentOptions} />
        ),
      },
    }),
    defineField({
